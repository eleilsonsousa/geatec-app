  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cadastro-cliente-cliente-list-cliente-list-module"], {
    ...
    function srcAppPagesCadastroClienteClienteListClienteListPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ClienteListPage = /*#__PURE__*/function (_generic_generic_list) {
        ...
        var _super2 = _createSuper(ClienteListPage);
        ...
        _createClass(ClienteListPage, [{
          ...
          value: function alterar(entity) {
            ...
            var _super = Object.create(null, {
              navigatePostParams: {
                get: function get() {
                  return _get(_getPrototypeOf(ClienteListPage.prototype), "navigatePostParams", _this3);
                }
              }
            });
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      this.clienteController.buscarPorId(entity.id).subscribe(function (result) {
                        if (result.length > 0) {
                          entity = result[0];

                          _super.navigatePostParams.call(_this4, 'cliente-cad', entity, index);
