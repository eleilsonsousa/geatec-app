      ...
      var ServicoCadPage = /*#__PURE__*/function (_generic_generic_cad_) {
        ...
        _createClass(ServicoCadPage, [{
          ...
          value: function ionViewWillEnter() {
            this.hideLoading(); //this.initForm();
          }
        }, {
          key: "ionViewDidEnter",
          ...
          value: function initForm() {
            ...
            if (!this.isAlterCad()) {
              ...
              this.precoBRL = src_app_utils_UtilApp__WEBPACK_IMPORTED_MODULE_5__["UtilApp"].formatCurrencyToBRL(this.entity.preco);
          ...
          key: "formatCurrency",
          value: function formatCurrency(event) {
            var result = src_app_utils_UtilApp__WEBPACK_IMPORTED_MODULE_5__["UtilApp"].formatCurrencyToBRL(event.value);
          ...
          value: function formatEntity() {
            this.entity.preco = src_app_utils_UtilApp__WEBPACK_IMPORTED_MODULE_5__["UtilApp"].formatCurrencyToDecimal(this.precoBRL);
            return this.entity;
          }
        }]);
