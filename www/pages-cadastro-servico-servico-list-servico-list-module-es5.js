(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cadastro-servico-servico-list-servico-list-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesCadastroServicoServicoListServicoListPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesCadastroServicoServicoListServicoListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServicoListPageRoutingModule", function () {
        return ServicoListPageRoutingModule;
      });
      /* harmony import */
      ...
      var _servico_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./servico-list.page */
      ...
      var ServicoListPageRoutingModule = function ServicoListPageRoutingModule() {
        _classCallCheck(this, ServicoListPageRoutingModule);
      };

      ServicoListPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesCadastroServicoServicoListServicoListModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServicoListPageModule", function () {
        return ServicoListPageModule;
      });
      /* harmony import */
      ...
      var _servico_list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./servico-list-routing.module */
      "./src/app/pages/cadastro/servico/servico-list/servico-list-routing.module.ts");
      /* harmony import */


      var _servico_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./servico-list.page */
      "./src/app/pages/cadastro/servico/servico-list/servico-list.page.ts");

      var ServicoListPageModule = function ServicoListPageModule() {
        _classCallCheck(this, ServicoListPageModule);
      };

      ServicoListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _servico_list_routing_module__WEBPACK_IMPORTED_MODULE_5__["ServicoListPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesCadastroServicoServicoListServicoListPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ServicoListPage", function () {
      ...
      var ServicoListPage = /*#__PURE__*/function (_generic_generic_list) {
        _inherits(ServicoListPage, _generic_generic_list);

        var _super2 = _createSuper(ServicoListPage);

        function ServicoListPage() {
          _classCallCheck(this, ServicoListPage);

          return _super2.apply(this, arguments);
        }

        _createClass(ServicoListPage, [{
          key: "ngOnInit",
          ...
          value: function buscarTodos() {
            ...
            this.showLoading();
            this.servicoController.buscarTodos().subscribe(function (result) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      this.showLoading();
                      this.servicoController.excluir(entity).subscribe(function () {
          ...
          value: function alterar(entity) {
            ...
            var _super = Object.create(null, {
              navigatePostParams: {
                get: function get() {
                  return _get(_getPrototypeOf(ServicoListPage.prototype), "navigatePostParams", _this3);
                }
              }
            });
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      this.servicoController.buscarPorId(entity.id).subscribe(function (result) {
                        if (result.length > 0) {
                          entity = result[0];

                          _super.navigatePostParams.call(_this4, 'servico-cad', entity, index);
      ...
      ServicoListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        /*! raw-loader!./servico-list.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/cadastro/servico/servico-list/servico-list.page.html"))["default"]
      })], ServicoListPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-cadastro-servico-servico-list-servico-list-module-es5.js.map